    ...
    return Selector<TUIChatSeparateViewModel, V2TimMessage?>(
        builder: ((context, value, child) {
          String? getForbiddenText() {
            final isChannel = (TencentUtils.india == widget.conversationID ||
                TencentUtils.korea == widget.conversationID ||
                TencentUtils.english == widget.conversationID ||
                TencentUtils.chinese == widget.conversationID ||
                TencentUtils.french == widget.conversationID ||
